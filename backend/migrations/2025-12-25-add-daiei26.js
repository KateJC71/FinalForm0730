/**
 * Migration: Add Daiei26 discount code
 * Date: 2025-12-25
 * Description: Add Daiei26 discount code (5% off, valid from 2024-01-01 to 2026-05-31)
 */
...
const migrations = [
  {
    query: `INSERT OR IGNORE INTO discount_codes
            ...
            VALUES ('Daiei26', 'Daiei 合作優惠', 'percentage', 5, 1, '2024-01-01', '2026-05-31', NULL, 0)`,
    description: 'Add Daiei26 (5% off)'
  }
];
...
function runMigration() {
  ...
  console.log('Running migration: Add Daiei26 discount code');
